...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yeyutinglou/TestDemo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yeyutinglou' => 'yeyutinglou@gmail.com' }
  s.source           = { :git => 'https://github.com/yeyutinglou/TestDemo.git', :tag => s.version.to_s }
